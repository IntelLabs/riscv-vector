  ...
  this: AnyFlatSpec with ChiselScalatestTester with BundleGenHelper =>
    ...
    def vLsuTest0(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.io.rfData(3).expect("hffffffffffffffffffffffffffffffff".U)
    ...
    def vLsuTest2(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.io.rfData(3).expect("hffffffffffffffffffffffff01234567".U)
            dut.io.rfData(4).expect("hffffffff0f0f0f0fffffffffffffffff".U)
            dut.io.rfData(5).expect("hffffffff0f0f0f0f0f0f0f0fffffffff".U)
            dut.clock.step(100)
        }
        }
    }
