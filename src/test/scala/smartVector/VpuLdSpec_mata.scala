  ...
  this: AnyFlatSpec with ChiselScalatestTester with BundleGenHelper =>
    ...
    def vLsuTest1(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            // dut.clock.step(100)
            dut.io.rfData(4).expect("hffffffffffffffff0123456789abcdef".U)
            dut.io.rfData(5).expect("hffffffffffffffffffffffffff0f0f0f".U)
        }
        }
    }
    ...
    def vLsuTest2(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.io.rfData(7).expect("hffffffffffffffffffff678901234567".U)
        }
        }
    }
    ...
    def vLsuTest3(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.io.rfData(4).expect("hffffffffffffffff0123456789abcdef".U)
            dut.io.rfData(5).expect("hfedcba98765432100f0f0f0f0f0f0f0f".U)
            dut.io.rfData(6).expect("hffffffffffffffff1234567890123456".U)
        }
        }
    }
    ...
    def vLsuTest4(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            // dut.clock.step(100)
            dut.io.rfData(4).expect("hffffffffffffffff0123456789abcdef".U)
            dut.io.rfData(5).expect("hffffffffffffffff0f0f0f0f0f0f0f0f".U)
        }
        }
    }
    ...
    def vLsuTest5(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.clock.step(1)
            // dut.clock.step(100)
            dut.io.rfData(4).expect("hffffffffffffffffffffffffffffffff".U)
            dut.io.rfData(5).expect("hffffffffffffffff0f0f0f0f0f0f0f0f".U)
        }
        }
    }
    ...
    def vLsuTest6(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.clock.step(1)
            // dut.clock.step(100)
            dut.io.rfData(4).expect("hffffffffffffffffffff20103478eeef".U)
        }
        }
    }
    ...
    def vLsuTest7(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.clock.step(1)
            // dut.clock.step(100)
            dut.io.rfData(4).expect("h00000000000000000000000089abcdef".U)
        }
        }
    }
    ...
    def vLsuTest8(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.io.rfData(5).expect("hffffffffffffffffffffffff33332222".U)
        }
        }
    }
