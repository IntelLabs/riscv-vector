...
//   def VLE16_V            = BitPat("b???000?00000?????101?????0000111")
    ...
    def vLsuTest0(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.clock.step(1)
            dut.io.rfData(4).expect("hffffffffffffffff0807060504030201".U)
            ...
            dut.io.rvuCommit.commit_vld.expect(true.B)
            dut.clock.step(1)
            dut.io.rfData(8).expect("hffffffffffffffffff0123456789abcd".U)
        }
        }
    }
    ...
    def vLsuTest2(): Unit = {
        ...
        test(new SmartVectorTestWrapper).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
            ...
            dut.io.rvuCommit.commit_vld.expect(true.B)
            dut.clock.step(1)
            dut.io.rfData(4).expect("h00080004001c00080000000c0004".U)
            ...
            dut.io.rvuCommit.commit_vld.expect(true.B)
            dut.clock.step(1)
            dut.io.rfData(8).expect("hcdefffff4567ba98ffffcdefffff4567".U)
        }
        }
    }
