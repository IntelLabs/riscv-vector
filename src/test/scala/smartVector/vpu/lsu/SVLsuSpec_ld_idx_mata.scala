...
trait VLsuBehavior_ld_idx_mata {
...
class VLsuSpec_ld_idx_mata extends AnyFlatSpec with ChiselScalatestTester with BundleGenHelper with VLsuBehavior_ld_idx_mata {
