...
trait VLsuBehavior_ld_seg_mutu {
...
class VLsuSpec_ld_seg_mutu extends AnyFlatSpec with ChiselScalatestTester with BundleGenHelper with VLsuBehavior_ld_seg_mutu {
