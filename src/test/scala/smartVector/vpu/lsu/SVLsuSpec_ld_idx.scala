  ...
  def vLsuTest0(): Unit =
    it should "pass: indexed load (uops=2, eew=8, sew=16, vl=16, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(true)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val ldReqs = Seq(
          (
            vluxei8.copy(vl = 16, uopIdx = 0, uopEnd = false, vsew = 1, destVRegStart = true, destVRegEnd = false),
            SrcBundleLd(vs2 = "h010004"),
            "h201f1e1d1c1b1a1918171615cdef4567".U,
            "hfff0".U,
          )
  ...
  def vLsuTest1(): Unit =
    it should "pass: indexed load (uops=2, eew=8, sew=64, vl=3, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(true)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val ldReqs = Seq(
          (
            vluxei8.copy(vl = 3, uopIdx = 0, uopEnd = false, vsew = 3, destVRegStart = true, destVRegEnd = true),
            SrcBundleLd(vs2 = "h01000"),
            "h0f0f0f0f0f0f0f0f0123456789abcdef".U,
            "h0000".U,
          ),
          (
            vluxei8.copy(vl = 3, uopIdx = 1, uopEnd = true, vsew = 3, destVRegStart = true, destVRegEnd = true),
            SrcBundleLd(vs2 = "h01000"),
  ...
  def vLsuTest2(): Unit =
    it should "pass: indexed load (uops=3, eew=16, sew=64, vl=5, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(true)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val ldReqs = Seq(
          (
            vluxei16.copy(vl = 5, uopIdx = 0, uopEnd = false, vsew = 3, destVRegStart = true, destVRegEnd = true),
            SrcBundleLd(vs2 = "h000000180000001000080000"),
            "hffffffffffffffff0123456789abcdef".U,
            "h0000".U,
          ),
          (
            vluxei16.copy(vl = 5, uopIdx = 1, uopEnd = false, vsew = 3, destVRegStart = true, destVRegEnd = true),
            SrcBundleLd(vs2 = "h000000180000001000080000"),
            "h0123456789abcdef0f0f0f0f0f0f0f0f".U,
            "h0000".U,
          ),
          (
            vluxei16.copy(vl = 5, uopIdx = 2, uopEnd = true, vsew = 3, destVRegStart = true, destVRegEnd = true),
            SrcBundleLd(vs2 = "h000000180000001000080000"),
            "h201f1e1d1c1b1a19fedcba9876543210".U,
            "hff00".U,
          ),
        )
  ...
  def vLsuTest3(): Unit =
    it should "pass: indexed load (uops=2, eew=32, sew=16, vl=5, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(true)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val ldReqs = Seq(
          (
            vluxei32.copy(vl = 5, uopIdx = 0, uopEnd = false, vsew = 1, destVRegStart = true, destVRegEnd = false),
            SrcBundleLd(vs2 = "h000000100000000000000008"),
            "h0".U,
            "hffff".U,
          ),
          (
            vluxei32.copy(vl = 5, uopIdx = 1, uopEnd = true, vsew = 1, destVRegStart = false, destVRegEnd = true),
            SrcBundleLd(vs2 = "h08"),
            "h201f1e1d1c1bffffcdef0f0fcdefffff".U,
            "hfc00".U,
          ),
        )
    ...
    it should "pass: indexed load (uops=2, eew=64, sew=16, vl=3, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(true)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val ldReqs = Seq(
          ...
          (
            vluxei64.copy(vl = 3, uopIdx = 1, uopEnd = true, vsew = 1),
            SrcBundleLd(vs2 = "h00020"),
            "h201f1e1d1c1b1a1918173456cdef0f0f".U,
            "hffc0".U,
          ),
        )
  ...
  def vLsuTest5(): Unit =
    it should "pass: indexed load (uops=2, eew=64, sew=16, vl=3, vstart=0) neg index value" in {
      test(new SmartVectorLsuTestWrapper(true)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val ldReqs = Seq(
          (
            vluxei64.copy(vl = 3, uopIdx = 0, uopEnd = false, vsew = 1),
            SrcBundleLd(vs2 = "hffff_ffff_ffff_fff0_ffff_ffff_ffff_fff8"),
            "h0".U,
            "hffff".U,
          ),
          (
            vluxei64.copy(vl = 3, uopIdx = 1, uopEnd = true, vsew = 1),
            SrcBundleLd(vs2 = "h00020"),
            "h201f1e1d1c1b1a19181734563489eeee".U,
            "hffc0".U,
          ),
        )
  ...
  def vLsuTest6(): Unit =
    it should "pass: indexed load (uops=2, eew=32, sew=16, vl=5, vstart=0) exception" in {
      test(new SmartVectorLsuTestWrapper(true)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val ldReqs = Seq(
          (
            vluxei32.copy(vl = 5, uopIdx = 0, uopEnd = false, vsew = 1),
            SrcBundleLd(vs2 = "h000000100000000000000008"),
            "h0".U,
            "hffff".U,
          ),
          (
            vluxei32.copy(vl = 5, uopIdx = 1, uopEnd = true, vsew = 1),
            SrcBundleLd(vs2 = "h60"),
            "h201f1e1d1c1b1a19cdef0f0fcdefffff".U,
            "hff00".U,
          ),
        )
