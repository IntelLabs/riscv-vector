...
class SmartVector extends Module {
    ...
    uopQueue.io.in.decodeIn <> decoder.io.out
    uopQueue.io.in.regFileIn <> regFile.io.out
    ...
    scalarRegWriteEn_E3 := uopQueue.io.out.mUop.bits.uopAttribute.scalarRegWriteEn

    val scalarRegWriteEn_E4 = Reg(Bool())
    scalarRegWriteEn_E4 := scalarRegWriteEn_E3

    val scalarRegWriteIdx_E3 = Reg(UInt(5.W))
    scalarRegWriteIdx_E3 := uopQueue.io.out.mUop.bits.uopAttribute.ldest
    ...
    io.out.rvuCommit.return_data_vld := scalarRegWriteEn_E4
    io.out.rvuCommit.return_data     := scalarRegWriteData_E4
    io.out.rvuCommit.return_reg_idx  := scalarRegWriteData_E4
