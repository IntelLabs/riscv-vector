      ...
      when(vs1_vsew === 0.U) {
        ...
        when((vsew === 0.U) && !vd_idx(0)) {
          ...
          when(vd_idx(0).asBool) {
            vrgather_byte_sel(i) := Cat(vs1((i / 4 + 1 + (VLEN / 32)) * 16 - 1, (i / 4 + (VLEN / 32)) * 16), 0.U(2.W)) + (i % 4).U
          }.otherwise {
          ...
          when(vd_idx(1, 0) === 0.U) {
            ...
            vrgather_byte_sel(i) := Cat(vs1((i / 8 + 1 + (VLEN / 64)) * 16 - 1, (i / 8 + (VLEN / 64)) * 16), 0.U(3.W)) + (i % 8).U
          }.elsewhen(vd_idx(1, 0) === 2.U) {
            vrgather_byte_sel(i) := Cat(vs1((i / 8 + 1 + (2 * VLEN / 64)) * 16 - 1, (i / 8 + (2 * VLEN / 64)) * 16), 0.U(3.W)) + (i % 8).U
          }.elsewhen(vd_idx(1, 0) === 3.U) {
            vrgather_byte_sel(i) := Cat(vs1((i / 8 + 1 + (3 * VLEN / 64)) * 16 - 1, (i / 8 + (3 * VLEN / 64)) * 16), 0.U(3.W)) + (i % 8).U
          }
        }
