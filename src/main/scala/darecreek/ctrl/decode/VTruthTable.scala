...
class VecDecode5 extends VecDecode {
  ...
  val table = Seq(
    ...
    VMV_X_S           -> BitPat("b1 010 01   00    11   1 0 0 0 0 0 0 0  0000"),
    VMV_S_X           -> BitPat("b1 000 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VFMV_F_S          -> BitPat("b1 010 01   00    11   1 0 0 0 0 0 0 0  0000"),
    VFMV_S_F          -> BitPat("b1 000 10   00    11   1 0 0 0 0 0 0 0  0000"),
    ...
    VMV1R_V           -> BitPat("b1 010 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMV2R_V           -> BitPat("b1 010 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMV4R_V           -> BitPat("b1 010 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMV8R_V           -> BitPat("b1 010 10   00    11   1 0 0 0 0 0 0 0  0000"),
  )
}