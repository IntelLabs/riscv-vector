...
class VecDecode5 extends VecDecode {
  ...
  val table = Seq(
    ...
    VMAND_MM          -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMNAND_MM         -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMANDN_MM         -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMXOR_MM          -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMOR_MM           -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMNOR_MM          -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMORN_MM          -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
    VMXNOR_MM         -> BitPat("b1 011 10   00    11   1 0 0 0 0 0 0 0  0000"),
